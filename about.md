...
**Thesis:** A strengthening of the concurrent normals theorem for polytopes
# Work Experience
### [Machine Learning Researcher @ PDMI AI lab, led by S. Nikolenko](https://ai.pdmi.ras.ru/)
* [2023] Researching DL-based simulators for learning recommendation systems @ *SBER x PDMI*
* [2022] Research DL-based heuristics for SAT-solvers @ *HUAWEI x PDMI*

### Math Optimization Specialist
* [2023] Logistic optimization via Mixed-Integer Linear Programming @ *Zyfra*
